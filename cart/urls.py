...
urlpatterns = [
    ...
    path('cart/add/<int:product_id>/<int:product_size>', views.add_cart_size, name='add_cart_size'),  # noqa:501
    path('cart/add/<int:product_id>', views.add_cart, name='add_cart'),
    path('cart', views.cart_detail, name='cart_detail'),
    path('cart/remove/<int:product_id>/<str:size>', views.cart_remove_size, name='cart_remove_size'),
